...
Switchery.prototype.setPosition = function (clicked) {
  ...
  if (checked === true) {
    ...
    if (window.getComputedStyle) jack.style.left = parseInt(window.getComputedStyle(switcher).width) - this.options.offsetWidth + 'px'; //zic: replace jack.offsetWidth. hack for bootstrap3 navbar
    else jack.style.left = parseInt(switcher.currentStyle['width']) - this.options.offsetWidth + 'px';
