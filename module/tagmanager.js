...
//            jQuery(this).spliceTag(parseInt(jQuery(this).attr("TagIdToRemove")));
   ...
   jQuery.fn.tagsManager = function (options) {
      ...
      return this.each(function() {
         ...
         var html = "";
         html += ("<input name='"+tagManagerOptions.hiddenInputName+"' type='hidden' value=''/>");
         obj.after(html);
         obj.data("lhiddenTagList", 
            obj.siblings("input[name='"+tagManagerOptions.hiddenInputName+"']")[0]
         );
