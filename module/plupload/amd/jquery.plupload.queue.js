define(function (require, exports) { return function (jQuery) {
			...
			this.each(function() {
                ...
                uploader.bind('StateChanged', function() {
                    if (uploader.state === plupload.STARTED) {
                        $('a,div.plupload_buttons', target).hide();
                        $('.plupload_file_status', target).show();
                    } else {
                        $('a,div.plupload_buttons', target).show();
                        $('.plupload_file_status', target).hide();
                    }
                });
