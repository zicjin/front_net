...
// wmd Begin Now!
// zic_Fix: convertToHtml(), add encode.
var Attacklab = Attacklab || {};
...
Attacklab.wmdBase = function(){
	...
	// entering links.
	var imageDialogText = "<p style='margin-top: 0px'><b>输入图片路径</b></p><p>你也可以加上图片title。如：<br />http://wmd-editor.com/images/cloud1.jpg   \"Optional title\"</p>";
	var linkDialogText = "<p style='margin-top: 0px'><b>输入网页地址</b></p><p>你也可以加上地址title。如:<br />http://wmd-editor.com/   \"Optional title\"</p>";
		...
		var convertToHtml = function(){
			...
			if (!/markdown/.test(wmd.wmd_env.output.toLowerCase())) {
				if (markdownConverter) {
				    inputBox.value = encodeHtml(markdownConverter.makeHtml(text));
